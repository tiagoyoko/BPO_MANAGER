...
export function LoginForm({
  ...
  const nextUrl = sanitizeAppPath(searchParams.get("next"));
            ...
            <div className="flex flex-col gap-6">
              ...
              {errorParam === "no-profile" && (
                <div className="rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800 dark:border-amber-800 dark:bg-amber-950/30 dark:text-amber-200">
                  Você não possui perfil cadastrado no sistema. Entre em contato
                  com o administrador do BPO.
                </div>
              )}
