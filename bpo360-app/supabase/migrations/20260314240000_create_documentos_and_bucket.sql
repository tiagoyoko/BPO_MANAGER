-- Story 3.4: Tabela documentos (metadados de anexos) e bucket para tarefas e solicitações.
-- Atende AC: lista por contexto (solicitacao_id / tarefa_id), RLS por bpo_id/cliente_id.
-- Timeline (Story 3.3): documento_anexado pode ser agregado via solicitacao_id/tarefa_id + created_at.
...
CREATE INDEX idx_documentos_tarefa_id ON public.documentos(tarefa_id);
...
-- Storage RLS: path = bpo_id/cliente_id/[solicitacao_id|tarefa_id]/uuid_nome
